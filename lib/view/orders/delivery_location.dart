...
class _DeliveryLocationPageState extends State<DeliveryLocationPage> {
      ...
      body: Column(
        children: [
          ...
          Padding(
            ...
            child: buildCategoryRow(context,controller.homeController),
          ),
          Expanded(
            child: Stack(
              children: [
  ...
  //           itemCount: controller.homeController.deliveryCategories.length,
  //           separatorBuilder: (_, __) => const SizedBox(width: 20),
  //           itemBuilder: (context, index) {
  //             final category = controller.homeController.deliveryCategories[index];
  //             return Obx(() {
  //               final isSelected =
  //                   controller.homeController.selectedDeliveryIndex.value == index;
  //               return Animate(
  //                 effects: const [
  //                   SlideEffect(
  //                     begin: Offset(0, 0.4),
